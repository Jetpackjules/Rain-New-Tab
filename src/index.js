...
import config from './config.json'; // This is the config file generated by the gulp task
...
function getRandomImageNumber() {
  ...
  return (seed % config.imagePairCount) + 1;
}

function loadTextures() {
  const imageNumber = getRandomImageNumber();
  console.log("Selected image number:", imageNumber);
